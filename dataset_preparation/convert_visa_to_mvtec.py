...
parser.add_argument('--data-folder',default='/path/to/dataset/visa/', type=str,help='the path to downloaded VisA dataset')
parser.add_argument('--save-folder',default='/path/to/dataset/visa/VisA_pytorch/', type=str,help='the target path to save the reorganized VisA dataset facilitating data loading in pytorch')
